  ...
  render() {
    return (
      <div className="warpper">
        <a href="https://github.com/shawn2016/chrome-plugins-demo" target="_blank" rel="noopener noreferrer" className="github-corner">
        ...
        <Footer>
          Copyright © 2018 <a target="_blank" rel="noopener noreferrer" href="https://github.com/shawn2016/chrome-plugins-demo">chrome-plugins-demo</a>
        </Footer>
      </div>
    );
  }
